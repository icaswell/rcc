...
def validate_config(config):
    required_keys = ["board_height", "board_width", "card_draw_probability", "square_height", "square_width", "players"]
...
TEST_GAME_CONFIG = {
        ...
        "initial_positions": {
            ...
            "Black": {
              ...
              (6, 6): lambda: Pawn(team="Black", name=f"black_pawn_7"), 
              (6, 7): lambda: Pawn(team="Black", name=f"black_pawn_8"), 
              (7, 5): lambda: Rook(team="Black", name=f"black_rook_1"), 
              (7, 7): lambda: Rook(team="Black", name=f"black_rook_2"), 
            ...
            "Elijah": {
              (4, 3): lambda: Zamboni(team="Elijah", name=f"pusher"), 
              (2, 2): lambda: Swapper(team="Elijah", name=f"swapper"), 
              }
        }
}
